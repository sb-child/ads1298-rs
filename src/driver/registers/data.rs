...
bitfield! {
    ...
    /// - 0 = RESP 解调电路关闭
    /// - 1 = RESP 解调电路开启
    resp_demod_en1, set_resp_demod_en1: 7;
    ...
    /// - 0 = RESP 调制电路关闭
    /// - 1 = RESP 调制电路开启
    resp_mod_en1, set_resp_mod_en1: 6;
    /// 保留 `[5]` `R/W` 复位 = `0`
    ///
    /// 始终写入 `1`
    rev_5, set_rev_5: 5;
...
bitfield! {
    ...
    /// - 0 = 禁用导联脱落比较器
    /// - 1 = 启用导联脱落比较器
    pd_loff_comp, set_pd_loff_comp: 1;
    /// 保留 `[0]` `R/W` 复位 `0`
    ///
    /// 始终写入 `0`
    rev_0, set_rev_0: 0;
...
bitfield! {
    ...
    wcta_channel, set_wcta_channel: 2, 0;
}
...
bitfield! {
    ...
    /// - 0 = 断电
    /// - 1 = 上电
    pd_wctc, set_pd_wctc: 7;
    /// 使 WCTB 断电 `[6]` `R/W` 复位 = `0`
    ///
    /// - 0 = 断电
    /// - 1 = 上电
    pd_wctb, set_pd_wctb: 6;
    ...
    wctb_channel, set_wctb_channel: 5, 3;
    ...
    wctc_channel, set_wctc_channel: 2, 0;
}
